...
namespace MVC_School.Controllers
{
    public class DocentenController : Controller
    {
        ...
        {
            var schoolDbContext = _context.Docenten
                                  .Include(d => d.Locatie);
        ...
        {
            if (id == null || _context.Docenten == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.Docenten == null)
            {
                return Problem("Entity set 'SchoolDbContext.Docenten'  is null.");
            }
            var docent = await _context.Docenten.FindAsync(id);
            if (docent != null)
            {
        ...
        {
          return (_context.Docenten?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
